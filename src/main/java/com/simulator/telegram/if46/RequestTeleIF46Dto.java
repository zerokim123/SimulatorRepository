 ...
 */
public class RequestTeleIF46Dto extends RequestTeleHeaderDto {

    /**
     * シリアルバージョンUID.
     */
    private static final long serialVersionUID = -7948697424417300236L;
    /**
     * クーポントランザクションID.
     */
